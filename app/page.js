...
export default function Page() {
      ...
      if (paid) {      
          if (txHashCache[trimmedId]) {
              ...
              try {
                ...
                const maxSearchBlocks = 100000000;
              ...
              <div style={{ maxWidth: 800, margin: '0 auto', lineHeight: 1.8, fontSize: 14 }}>
                ...
                <div style={{ marginBottom: 20, color: '#d4d4e8' }}>
                  ...
                  <ol style={{ paddingLeft: 20 }}>
                    ...
                    <li>Click "Pay Invoice" to approve and pay in one step</li>
                    <li>Complete both transactions in your wallet</li>
                  </ol>
                </div>
  ...
  }, [currentPage, invoice, lookupId, managedInvoice, manageId, editMode, editNewId, editNewAmount, editNewDesc, newId, newAmount, newDesc, canCreate, creating, paying, editing, deleting, wallet, decimals, lastTxHash, usdc, payArc]);
      ...
      <style>{`
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .logo-badge {
          width: 40px;
          height: 40px;
          background: linear-gradient(135deg, #6b7bff, #4f6bff);
          border-radius: 10px;
        }
        .nav-title {
          font-size: 11px;
